  ...
  return (
    <div className="container mx-auto px-4  py-8">
      <div className="p-6 mx-auto">
        ...
        <div className="my-6">
          {/* Content for question 23 */}
          <h2
            data-aos="fade-right"
            className="text-2xl text-secondary font-bold mb-2"
          >
            23. What is an airtightness test and why do I need it?
          </h2>
          <p
            data-aos="fade-up"
            className="mb-4 text-base md:text-lg lg:text-xl "
          >
            An airtightness test, also known as an air permeability test or
            blower door test, is a diagnostic procedure used to measure the air
            leakage rate of a building's envelope. During the test, a temporary
            airtight barrier, typically a large fan mounted on an adjustable
            frame, is installed in an external doorway or opening of the
            building. The fan depressurizes or pressurizes the building,
            creating a pressure difference between the inside and outside. By
            measuring the airflow required to maintain this pressure difference,
            the air leakage rate of the building can be quantified.
          </p>
          <p
            data-aos="fade-up"
            className="mb-4 text-base md:text-lg lg:text-xl "
          ...
          <ul className="list-disc ml-6 mb-4">
            ...
            <li className="text-base md:text-lg lg:text-xl">
              ...
              consumption for heating and cooling. By identifying and reducing
            ...
            <li className="text-base md:text-lg lg:text-xl">
              ...
              environment, compromising indoor air quality and occupant comfort.
              By minimizing air leakage through an airtightness test, buildings
            ...
            <li className="text-base md:text-lg lg:text-xl">
              ...
              demonstrate compliance with these regulations. By conducting an
            ...
            <li className="text-base md:text-lg lg:text-xl">
              ...
              become more difficult and costly to rectify. It also helps
              identify areas where construction techniques or materials may need
              improvement to achieve better airtightness in future projects.
            </li>
          </ul>
          {/* Content for question 24 */}
          <h2
            data-aos="fade-right"
            className="text-2xl text-secondary font-bold mb-2"
          >
          ...
          <p
            ...
            className="mb-4 text-base md:text-lg lg:text-xl "
          >
            A ventilation test, also known as a ventilation performance test or
            air flow rate test, is a diagnostic procedure used to assess the
            effectiveness and performance of a building's ventilation system.
            The test measures the airflow rates through the ventilation system
            and evaluates whether the system is providing adequate ventilation
          ...
          <ol className="list-decimal ml-6 mb-4">
            ...
            <li className="text-base md:text-lg lg:text-xl">
              ...
              functioning as intended and providing sufficient air exchange to
            ...
            <li className="text-base md:text-lg lg:text-xl">
              ...
              occupants can ensure that the ventilation system is providing
            ...
            <li className="text-base md:text-lg lg:text-xl">
              ...
              helps identify deficiencies in the ventilation system that may
            ...
            <li className="text-base md:text-lg lg:text-xl">
              ...
              airflow rates through a ventilation test, building owners can
            ...
            <li className="text-base md:text-lg lg:text-xl">
              ...
              often required to demonstrate compliance with these regulations
            ...
            <li className="text-base md:text-lg lg:text-xl">
              ...
              and address issues such as duct leakage, inadequate airflow rates,
              or improper system balancing before they impact occupant comfort
              or indoor air quality.
            </li>
          </ol>
          {/* Content for question 25 */}
          <h2
            data-aos="fade-right"
            className="text-2xl text-secondary font-bold mb-2"
          >
          ...
          >
            An airtightness test, also known as an air permeability test or
            blower door test, is conducted using specialized equipment and
            procedures. Here's a step-by-step overview of how an airtightness
          ...
          <ol className="list-decimal ml-6 mb-4">
            ...
            <li className="text-base md:text-lg lg:text-xl">
              ...
              pressure, while depressurization involves extracting air from the
              building to decrease the internal pressure. Both methods create a
              pressure difference between the inside and outside of the
            ...
            <li className="text-base md:text-lg lg:text-xl">
              ...
              improving airtightness and reducing air leakage.
            </li>
          </ol>
          {/* Content for question 26 */}
          <h2
            data-aos="fade-right"
            className="text-2xl text-secondary font-bold mb-2"
          >
          ...
          <p
            ...
            className="mb-4 text-base md:text-lg lg:text-xl "
          >
            Preparing your building for an airtightness test is essential to
            ensure accurate and reliable results. Here are the steps you can
          ...
          <p
            ...
            className="mb-4 text-base md:text-lg lg:text-xl "
          >
            By following these steps and adequately preparing your building for
            an airtightness test, you can help ensure accurate and reliable test
            results, identify areas of air leakage, and take appropriate
            measures to improve energy efficiency and building performance.
          </p>
        </div>
      </div>
    </div>
...
export default AirTightnessFaqs;
