...
export default function OMannual() {
  return (
    <div>
      <div className="container mx-auto px-4 py-8">
        <div className="mx-auto p-6">
          ...
          >
            A Building User Guide is a document provided to occupants or users
            of a building that contains essential information about the
            building's design, construction, operation, maintenance, and safety
            features. The purpose of a Building User Guide is to help occupants
            understand how to use and maintain the building effectively, promote
            occupant comfort and safety, and ensure the efficient operation of
            building systems and equipment. Here are the typical components
          ...
          <ul className="list-disc ml-6 mb-4">
            ...
            <li className="text-base md:text-lg lg:text-xl">
              ...
              section may provide an overview of how each system operates, its
          ...
          <p
            ...
            className="mb-4 text-base md:text-lg lg:text-xl "
          >
            Overall, a Building User Guide serves as a valuable resource for
            occupants to understand and interact with the building effectively,
            maintain occupant comfort and safety, and contribute to the
            efficient operation and sustainability of the built environment.
          </p>
          ...
          <p
            ...
            className="mb-4 text-base md:text-lg lg:text-xl "
          >
            In the context of BREEAM (Building Research Establishment
            Environmental Assessment Method), a Building User Guide refers to a
            document that provides occupants or users of a building with
            information on how to operate, maintain, and interact with the
            building in an environmentally responsible and sustainable manner.
            The Building User Guide is one of the requirements under BREEAM
            assessments to achieve credits related to user education and
          ...
          <p
            ...
            className="mb-4 text-base md:text-lg lg:text-xl "
          >
            By providing occupants with a comprehensive Building User Guide,
            buildings can promote sustainable behaviours, enhance occupant
            satisfaction and well-being, and contribute to the overall
            environmental performance and resilience of the built environment.
          </p>
        </div>
      </div>
    </div>
