...
export default function FloodRisksFaqs() {
  return (
    <div>
      <div className="container mx-auto px-4 py-8">
        <div className="mx-auto p-6">
          ...
          >
            A Flood Risk Assessment (FRA) is a comprehensive evaluation
            conducted to assess the potential risks and impacts of flooding on a
            site or development project. The assessment aims to identify flood
            hazards, evaluate potential consequences, and recommend appropriate
            mitigation measures to reduce the risk of flood-related damage and
            ensure the safety of people and property. Here's an overview of what
          ...
          <ul className=" ml-6 mb-4">
            ...
            <li className="text-base md:text-lg lg:text-xl">
              ...
              susceptibility to different types of flooding, such as river
              flooding, surface water flooding, groundwater flooding, and tidal
            ...
            <li className="text-base md:text-lg lg:text-xl">
              ...
              the potential impact of flooding on the site and surrounding
            ...
            <li className="text-base md:text-lg lg:text-xl">
              ...
              infrastructure, evacuation routes, and emergency response
              capabilities. Vulnerable assets and populations are identified to
            ...
            <li className="text-base md:text-lg lg:text-xl">
              ...
              development. These measures may include flood defences (e.g.,
              levees, floodwalls, embankments), floodplain management
              strategies, building design considerations (e.g., flood-resistant
              construction, raised floor levels), drainage improvements, green
            ...
            <li className="text-base md:text-lg lg:text-xl">
              ...
              may include compliance with national flood risk management
              policies, local planning regulations, floodplain development
            ...
            <li className="text-base md:text-lg lg:text-xl">
              ...
              affected residents. Consultation helps gather local knowledge,
            ...
            <li className="text-base md:text-lg lg:text-xl">
              ...
              maps, vulnerability assessments, mitigation recommendations, and
              regulatory compliance assessments. The report serves as a basis
              for decision-making, planning approvals, public disclosure, and
              regulatory compliance.
            </li>
          </ul>
          <p
            ...
            className="mb-4 text-base md:text-lg lg:text-xl "
          >
            Overall, a Flood Risk Assessment provides valuable insights into the
            potential risks and impacts of flooding on a site or development
            project, helping stakeholders make informed decisions, prioritize
            flood risk management measures, and ensure the resilience and safety
            of communities in flood-prone areas.
          </p>
          ...
          <p
            ...
            className="mb-4 text-base md:text-lg lg:text-xl "
          >
            You may need a Flood Risk Assessment (FRA) in various situations,
            particularly when planning new developments or making changes to
          ...
          <ul className=" ml-6 mb-4">
            ...
            <li className="text-base md:text-lg lg:text-xl">
              ...
              This ensures that proposed developments are located and designed
            ...
            <li className="text-base md:text-lg lg:text-xl">
              ...
              impacts, including flood risk, may be required to demonstrate
            ...
            <li className="text-base md:text-lg lg:text-xl">
              ...
              lenders evaluate the level of flood risk associated with the
              property, assess potential impacts on property value and insurance
            ...
            <li className="text-base md:text-lg lg:text-xl">
              ...
              on flood risk, water flow patterns, and floodplain dynamics. This
              ensures that infrastructure projects are designed and implemented
            ...
            <li className="text-base md:text-lg lg:text-xl">
              ...
              response plans, and prioritize flood risk management measures.
              This helps improve community resilience, enhance emergency
            ...
            <li className="text-base md:text-lg lg:text-xl">
              ...
              insurers to accurately price insurance policies based on the level
            ...
            <li className="text-base md:text-lg lg:text-xl">
              ...
              that developments are located, designed, and managed in a manner
              that reduces flood risk, protects the environment, and ensures the
          ...
          <p
            ...
            className="mb-4 text-base md:text-lg lg:text-xl "
          >
            In summary, you may need a Flood Risk Assessment in various
            situations related to planning applications, environmental
            permitting, property transactions, infrastructure projects,
            emergency planning, insurance purposes, and regulatory compliance.
            Conducting a Flood Risk Assessment helps identify flood hazards,
            assess potential impacts, and recommend appropriate mitigation
            measures to reduce flood risk and ensure the safety and resilience
            of communities and developments in flood-prone areas.
          </p>
        </div>
      </div>
    </div>
