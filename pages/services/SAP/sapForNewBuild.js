                ...
                <div className="lg:pr-4">
                  <div className="max-w-xl text-base leading-7 font-semibold text-secondary lg:max-w-lg">
                    ...
                    <p
                      ...
                      data-aos="fade-up"
                    >
                      We, at SEES, have extensive experience with carrying out
                      SAP calculations all over the UK, ranging from 200+
                      dwelling sites to single dwelling properties.
                    </p>
                    <p
                      className="mt-6 text-xl leading-8 text-primary"
                      data-aos="fade-up"
                    >
                      We provide cost effective solutions to help your project
                      pass building regulations while spending as little money
                      as possible.
                    </p>
                    <p
                      ...
                      data-aos="fade-up"
                    >
                      All we would require to carry out a SAP calculations are:
                    </p>
                   ...
                   <svg
                    ...
                    <p className="mt-8 text-primary">
                      Credits are awarded across 9 assessment sections and an
                    ...
                    <ul role="list" className="mt-8  space-y-4 text-primary">
                      ...
                      <li className="flex gap-x-3" data-aos="fade-up">
                        ...
                        <span>
                          <strong className="font-semibold text-primary">
                            Public - Education, Healthcare, Prisons and Law
                            Courts
                          </strong>
                        </span>
                      </li>
                      ...
                      <li className="flex gap-x-3" data-aos="fade-up">
                        ...
                        <span>
                          <strong className="font-semibold text-primary">
                            Other - Residential Institutions (Short term),
                    ...
                    <ul role="list" className="mt-8 space-y-4 text-primary">
                      ...
                      <li className="flex gap-x-3" data-aos="fade-up">
                        ...
                        <span>
                          <strong className="font-semibold text-primary">
                            Man 04 - Airtightness testing & Thermographic Survey
                          </strong>
                        </span>
                      </li>
                      <li className="flex gap-x-3" data-aos="fade-up">
                      ...
                      <li className="flex gap-x-3" data-aos="fade-up">
                        ...
                        <span>
                          <strong className="font-semibold text-primary">
                            Hea 05 – Acoustic testing & Design advice
                          </strong>
                        </span>
                      </li>
                      <li className="flex gap-x-3" data-aos="fade-up">
                        ...
                        <span>
                          <strong className="font-semibold text-primary">
                            Ene 01 – Energy Modelling (BRUKL & EPC)
                          </strong>
                        </span>
                      </li>
                      <li className="flex gap-x-3" data-aos="fade-up">
                      ...
                      <li className="flex gap-x-3" data-aos="fade-up">
                        ...
                        <span>
                          <strong className="font-semibold text-primary">
                            Ene 04 - Low zero carbon assessments for renewable
                            technologies
                          </strong>
                        </span>
                      </li>
                      ...
                      <li className="flex gap-x-3" data-aos="fade-up">
                        ...
                        <span>
                          <strong className="font-semibold text-primary">
                            Wat 01 – Water Efficiency Calculations
                          </strong>
                        </span>
                      </li>
                      <li className="flex gap-x-3" data-aos="fade-up">
                        ...
                        <span>
                          <strong className="font-semibold text-primary">
                            Pol 03 – Flood Risk Assessment & Surface Run-off
                          </strong>
                        </span>
                      </li>
                      <li className="flex gap-x-3" data-aos="fade-up">
                        ...
                        <span>
                          <strong className="font-semibold text-primary">
                            Pol 05 – Noise Impact Assessment and Testing
                          </strong>
                        </span>
                      </li>
                    </ul>
